...
import styles from '/src/css/algorithmes.css';
...
<nav id="algorithmes-nav">
<div id="algorithmes-nav-code">
...
<div id="algorithmes-nav-html">

<iframe src="/static/algo/OpenClassrooms/Validez_les_donnees_saisies_par_vos_utilisateurs/index.html"></iframe>
